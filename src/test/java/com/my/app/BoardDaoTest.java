...
public class BoardDaoTest {
	...
	public void deleteLikeTest() {
		...
		assertTrue(boardDao.deleteLike() == 1);
	}
	@Test
	public void insertLikeTest() {
		...
		assertTrue(boardDao.insertLike(dto) == 1);
	}
	@Test
	public void updateLikeTest() {
		...
		LikeDto dto2 = new LikeDto(221, "dlawogud", 0);
		assertTrue(boardDao.updateLike(dto2) == 1);
	}
	@Test
	public void selectLikeTest() {
		...
		map.put("bno", 222);
		map.put("userId", "dlawogud");
		
		System.out.println("결과 = " + boardDao.selectLike(map));
